...
function OtherSections({ onSubmit, prefilledData }) {
  ...
  useEffect(() => {
    if (prefilledData) {
      setFormData({
        ...
        courseTitle: prefilledData.courseTitle || '',
        credits: prefilledData.credits || '',
        objectives: prefilledData.objectives || '',
        outcomes: prefilledData.outcomes || '',
        overview: prefilledData.overview || '',
        textbooks: prefilledData.textbooks || '',
